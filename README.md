...
📌 Sobre mim
Sou desenvolvedora em formação, com foco em desenvolvimento de software, banco de dados e segurança da informação.  
Tenho interesse em construir sistemas bem estruturados, organizados e seguros, com atenção à lógica, aos dados e às boas práticas.

Atualmente atuo como estagiária de marketing, experiência que contribuiu para desenvolver visão estratégica, organização, comunicação e responsabilidade com projetos — habilidades que levo para a área de tecnologia.

Busco expandir minha atuação profissional em desenvolvimento e dados, adquirindo experiência prática por meio de projetos, estudos contínuos e oportunidades que me desafiem tecnicamente.

🎯 Objetivo profissional
Atuar como desenvolvedora ou na área de segurança da informação, com foco em sistemas confiáveis, dados e boas práticas de segurança.
